...
<div id="opp">
	...
	<div class="center">
		<ul class="center_ul clearfix">
			<li class="center_li" @click="onClick"><a href="#"><i class="fa fa-map"></i>章节练习</a><p>{{drug.zt_num}}</p></li>
			<li class="center_li"><a href="#"><i class="fa fa-map"></i>真题训练</a><p>{{drug.zj_num}}</p></li>
